...
EXTRACT(year from t1.START_DATE) year,
EXTRACT (month from t1.START_DATE) month,
TO_CHAR(t1.END_DATE, 'WW') week,
t1.END_DATE endDate,
...
FROM COMMON_GNOC.REQUEST_SCHEDULE t1
LEFT JOIN COMMON_GNOC.UNIT t2 on t1.UNIT_ID = t2.UNIT_ID
WHERE 1 = 1
