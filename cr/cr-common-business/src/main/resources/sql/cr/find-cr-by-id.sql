...
--//                         cr.cr_number crNumber,
    ...
    , cr.TOTAL_AFFECTED_CUSTOMERS totalAffectedCustomers , cr.TOTAL_AFFECTED_MINUTES totalAffectedMinutes
    , cr.LIST_WO_ID as listWoId , cr.IS_TRACING_CR as isTracingCr
    , cr.NODE_SAVING_MODE as nodeSavingMode, cr.handover_ca handoverCa,  cr.is_handover_ca isHandoverCa
