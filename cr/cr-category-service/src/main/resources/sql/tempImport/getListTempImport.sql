...
SELECT
  ...
  lr.CREATER_TIME createrTime,
  lr.PROCESS_TYPE_ID processTypeId,
  lr.IS_ACTIVE isActive,
  ...
  lr.IS_MEC_FILE isMecFile,
  lr.PATH path,
  lr.APPLIED_SYSTEM appliedSystem,
  lr.IS_EDITABLE isEditable
FROM list_result lr
WHERE 1 = 1
