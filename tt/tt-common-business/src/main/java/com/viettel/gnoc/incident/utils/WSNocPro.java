...
public class WSNocPro {
  ...
  private static WSNocPro wSNocPro = null;

  public static synchronized WSNocPro getWsNocPro() {
    if (wSNocPro == null) {
      wSNocPro = new WSNocPro();
    }
    return wSNocPro;
  }
  ...
  public ResponseBO getAlarmClearGNOC(String requestId, CfgServerNocDTO cfgServerNocDTO,
    ...
    ResponseBO lst = null;
    StringUtils.printLogData("Access Method getAlarmClearGNOC: ", gnocActionBO, GnocActionBO.class);
    try {
      ...
      StringUtils.printLogData("Response getAlarmClearGNOC: ", lst, ResponseBO.class);
    } catch (Exception e) {
      throw e;
    }
    return lst;
