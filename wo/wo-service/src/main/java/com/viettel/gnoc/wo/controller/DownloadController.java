...
@RestController
@Slf4j
@RequestMapping(Constants.WO_API_PATH_PREFIX + "download")
public class DownloadController {
  ...
  public ResponseEntity<Resource> onDownloadFileTemplate(String moduleName)
    ...
    switch (moduleName) {
      case "WO":
        file = woBusiness.getTemplateImportWo();
        break;
      case "WO_ASSSETS":
        file = woBusiness.getTemplateImportAssetsForWo();
        break;
      case "WO_TRANSFER_OF_PROPERTY_ATTACH":
        file = woBusiness.getTemplateImportWoTranSferOfProperty();
        break;
      case "WO_DOWNGRADE_WITH_DRAWAL_ATTACH":
        file = woBusiness.getTemplateImportWoDowngradeWithDrawal();
        break;
      case "WO_UPGRADE_STATION_ATTACH":
        file = woBusiness.getTemplateImportWoUpgradeStation();
        break;
      case "WO_TEST_SERVICE_CR":
        file = woBusiness.getTemplateExportWOTestServiceFromCR();
        break;
      case "WO_TEST_SERVICE_WO":
        file = woBusiness.getTemplateExportWOTestServiceFromWO();
        break;
      default:
        file = null;
        break;
