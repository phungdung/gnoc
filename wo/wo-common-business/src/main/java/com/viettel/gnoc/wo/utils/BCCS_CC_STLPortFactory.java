...
@Getter
@Setter
public class BCCS_CC_STLPortFactory {
  ...
  public void init() {
    if (wsFactory == null) {
      ...
      wsPoolableObjectFactory.setServiceName("BCCS_CC_STL");
      wsFactory = new WsGenericObjectPool<ServiceManagement>(wsPoolableObjectFactory, maxActive);
    }
  }
