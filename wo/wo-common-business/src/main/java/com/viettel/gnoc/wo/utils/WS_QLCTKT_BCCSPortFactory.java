...
@Getter
@Setter
public class WS_QLCTKT_BCCSPortFactory {
  ...
  public void init() {
    if (wsFactory == null) {
      ...
      wsPoolableObjectFactory.setServiceName("WS_QLCTKT_BCCS");
      wsFactory = new WsGenericObjectPool<BccsService>(wsPoolableObjectFactory, maxActive);
    }
  }
