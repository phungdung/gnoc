...
@Getter
@Setter
public class KTTSVsmartPortFactory {
  ...
  public void init() {
    if (wsFactory == null) {
      ...
      wsPoolableObjectFactory.setServiceName("KTTS2");
      wsFactory = new WsGenericObjectPool<VSmartService>(wsPoolableObjectFactory, maxActive);
    }
  }
