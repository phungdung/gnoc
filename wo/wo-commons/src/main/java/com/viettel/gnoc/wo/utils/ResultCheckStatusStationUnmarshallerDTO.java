...
public class ResultCheckStatusStationUnmarshallerDTO implements NimHtUnmarshallerDTO {

  @XmlElement(name = "return")
  ResultCheckStatusStations resultCheckStatusStations;
  ...
  public ResultCheckStatusStations getResultCheckStatusStations() {
    return resultCheckStatusStations;
  }
