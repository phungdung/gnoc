...
@Getter
@Setter
public class WSNIMS_HT_GOLOBAL_PortFactory {
  ...
  public void init() {
    if (wsFactory == null) {
      ...
      wsPoolableObjectFactory.setServiceName("NIMS_HT_GLOBAL");
      wsFactory = new WsGenericObjectPool<InfraWS>(
          wsPoolableObjectFactory, maxActive);
    }
  }
