...
@NoArgsConstructor
@Entity
@Table(name = "MR_HARD_DEVICES_CHECKLIST")
public class MrHardDevicesCheckListEntity {

  @Id
  @SequenceGenerator(name = "generator", sequenceName = "MR_HARD_DEVICES_CHECKLIST_SEQ", allocationSize = 1)
  @GeneratedValue(strategy = SEQUENCE, generator = "generator")
  @Column(name = "MR_HARD_DEVICES_CHECKLIST_ID")
  ...
  public MrHardDevicesCheckListDTO toDTO() {
    MrHardDevicesCheckListDTO dto = new MrHardDevicesCheckListDTO(
