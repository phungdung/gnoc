...
@AllArgsConstructor
@Slf4j
@MultiFieldUnique(message = "{validation.mrHardGroupConfig.null.unique}", clazz = MrHardUnitConfigEntity.class, uniqueFields = "marketCode,region,arrayCode,deviceType,stationCode", idField = "id")
public class MrHardUnitConfigDTO extends BaseDto {
  ...
  //Constructor
  public MrHardUnitConfigDTO(Long id, String marketCode, String region, String arrayCode,
  ...
  public MrHardUnitConfigEntity toEntity() {
    MrHardUnitConfigEntity model = new MrHardUnitConfigEntity(
        id,
        marketCode,
        region,
        arrayCode,
