...
@AllArgsConstructor
@Entity
@Table(schema = "OPEN_PM", name = "MR_CFG_PROCEDURE_TEL")
public class MrCfgProcedureTelEntity {

  @Id
  @SequenceGenerator(name = "generator", sequenceName = "OPEN_PM.MR_CFG_PROCEDURE_TEL_SEQ", allocationSize = 1)
  @GeneratedValue(strategy = SEQUENCE, generator = "generator")
  @Column(name = "PROCEDURE_ID", length = 22)
...
//duongnt
  ...
  public MrCfgProcedureTelDTO toDTO() {
    return new MrCfgProcedureTelDTO(procedureId, marketCode, arrayCode, deviceType, deviceTypeCR,
