...
public class Users {
  ...
  public UsersInsideDto toDTO() {
    return new UsersInsideDto(userId, username, fullname, birthDay, sex, unitId, isEnable, email,
        mobile,
        groupOperateId,
        officeId, shopId, shopName, userLanguage, userTimeZone, staffCode, isUseVsmart, isAdmin,
        arrayAction,
        isNotReceiveMessage, departmentId, nationCode, nationId, relateUnits, functionNiam,
        unitIdNew, deleteGroup, hrUnitId, updateTimeUnit, approveStatus, approveUser, resourceCode);
  }
}
