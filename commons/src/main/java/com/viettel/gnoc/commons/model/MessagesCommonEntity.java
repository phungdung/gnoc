 ...
 * @author thanhlv12
 * @version 1.0
 * @since 11/06/2016 10:39:10
 */
@Entity
@Setter
@Getter
@NoArgsConstructor
@Table(schema = "COMMON_GNOC", name = "MESSAGES")
public class MessagesCommonEntity {
  ...
  public MessagesCommonEntity(Long messageId, Long smsGatewayId, String content, Long senderId,
      Long receiverId,
