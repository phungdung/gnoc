 ...
 * the License.
 */
package com.viettel.tracing;


import com.viettel.tracing.customizer.JaegerDiagnosticContextTracerBuilderCustomizer;
import com.viettel.tracing.diagnostic.JaegerDiagnosticContext;
import com.viettel.tracing.diagnostic.SpanDiagnosticContext;
import com.viettel.tracing.metrics.CustomTracerGnoc;
...
public class JaegerAutoConfigurationGnoc {
  ...
  @Bean
  public io.opentracing.Tracer tracer(Sampler sampler, Reporter reporter, Metrics metrics) {

    final CustomTracerGnoc.CustomBuilder builder =
        (CustomTracerGnoc.CustomBuilder) new CustomTracerGnoc.CustomBuilder(serviceName)
  ...
  private Reporter getHttpReporter(Metrics metrics,
    ...
    io.jaegertracing.thrift.internal.senders.HttpSender.Builder builder =
        new io.jaegertracing.thrift.internal.senders.HttpSender.Builder(
            httpSenderProperties.getUrl());
  ...
  public static class JaegerDiagnosticContextConfiguration {
    ...
    @Bean
    public TracerBuilderCustomizer diagnosticContextTracerBuilderCustomizer(
