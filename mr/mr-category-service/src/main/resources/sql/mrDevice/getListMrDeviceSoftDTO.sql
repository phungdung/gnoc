...
FROM MR_DEVICE T1
LEFT JOIN OPEN_PM.MR_SCHEDULE_TEL T2
ON T1.DEVICE_ID = T2.DEVICE_ID
AND T2.MR_HARD  =1
LEFT JOIN OPEN_PM.MR_CFG_CR_UNIT_TEL T3
ON T1.MARKET_CODE   = T3.MARKET_CODE
AND T1.ARRAY_CODE   = T3.ARRAY_CODE
AND T1.NETWORK_TYPE = T3.NETWORK_TYPE
