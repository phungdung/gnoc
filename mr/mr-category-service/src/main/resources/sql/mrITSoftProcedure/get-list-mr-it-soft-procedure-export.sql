...
SELECT
      ...
      CASE
        WHEN CP.IMPORTANT_LEVEL = '3'
        THEN :normal
        WHEN CP.IMPORTANT_LEVEL = '2'
        THEN :important
        ELSE :veryImportant
      END importantLevelName,
      ...
      CASE
        WHEN CP.PRIORITY_CR = '3'
        THEN :immediately
        when CP.PRIORITY_CR = '0'
        THEN :high
        when CP.PRIORITY_CR = '1'
        THEN :medium
        when CP.PRIORITY_CR = '2'
        THEN :short
      END priorityCrName,
      CP.TYPE_CR typeCr,
      CASE
